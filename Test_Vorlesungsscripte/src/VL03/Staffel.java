...
class Stab {
    ...
    public synchronized void nimm() {   // geschützt: hier kommt nur einer gleichzeitig rein
        System.out.println("Stab haben will "
    ...
    public synchronized void abgeben() {    // geschützt: hier kommt nur einer gleichzeitig rein
