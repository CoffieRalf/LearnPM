...
public class MyThread implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Achtung: Runnable-Objekt wird wiederverwendet und wird auf 2 bis 3
         * Threads parallel ausgeführt. Dabei können diese sich gegenseitig
         * ablösen! Achten Sie auf die Ausgabe ("pool-1-thread-3") ...
         *
         * Wenn das stört, muss entsprechend synchronisiert werden.
         *
         * Da `Thread` das Interface `Runnable` implementiert, können auch
         * "echte" Threads über den Executor mehrfach gestartet werden.
         *
         */
