...
public class MultiThreadMethodSync implements Runnable {
    int val = 0;

    public synchronized int incrVal() { // Synchronisierung auf sich selbst (!)
        int erg = val;
        // Zeit schinden ;-)
    ...
    public static void main(String[] args) {
        MultiThreadMethodSync x = new MultiThreadMethodSync();
