...
public class MultiThreadObjSync implements Runnable {
    int val = 0;
    private Object waechter = new Object(); // gemeinsames Sperr-Objekt
    ...
    public static void main(String[] args) {
        MultiThreadObjSync x = new MultiThreadObjSync();
